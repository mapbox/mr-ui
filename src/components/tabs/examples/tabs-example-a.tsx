...
export default function Example(): ReactElement {
  ...
  return (
    ...
    items={[
      ...
      { id: 'three', label: 'Tab 3 title', content: <div className='scroll-styled'><div>Tab 3 content</div><div>Tab 3 content</div><div>Tab 3 content</div><div>Tab 3 content</div><div>Tab 3 content</div><div>Tab 3 content</div><div>Tab 3 content</div></div> },
